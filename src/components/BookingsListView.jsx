...
import { ChevronUp, ChevronDown, Download, Search, Filter, MapPin, Bus } from 'lucide-react';
import { StatusPill, formatCurrency, formatDate, formatTime } from '../utils/formatter.jsx';
...
const BookingsListView = ({ filteredBookings, filters, onFilterChange, onClear, sortConfig, requestSort, handleViewDetail, exportToCSV }) => {
    ...
    return (
        <div className="space-y-6 p-4 sm:p-6 lg:p-8">
            ...
            <FiltersComponent filters={filters} onFilterChange={onFilterChange} onClear={onClear} />
